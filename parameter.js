let mod = {
    ...
    CONSTRUCTION_PRIORITY: (room) => {
        const priority = [STRUCTURE_LINK,STRUCTURE_TERMINAL,STRUCTURE_STORAGE,STRUCTURE_TOWER,STRUCTURE_POWER_SPAWN,STRUCTURE_NUKER,STRUCTURE_OBSERVER,STRUCTURE_ROAD,STRUCTURE_CONTAINER,STRUCTURE_EXTRACTOR,STRUCTURE_LAB,STRUCTURE_WALL,STRUCTURE_RAMPART];
        if (room.structures.spawns.length) {
            return [STRUCTURE_SPAWN, STRUCTURE_EXTENSION, ...priority];
        }
        return [STRUCTURE_EXTENSION, STRUCTURE_SPAWN, ...priority];
    },
