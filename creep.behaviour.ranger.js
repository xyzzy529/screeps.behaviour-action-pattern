...
/**
 * Check if Ranger has heal part and use it if nearby.
 *  - Renamed from .heal() to .medic() to reduce potential confusion on Game command.
 * @param  creep current creep under command
 * @return none.
 */
mod.medic = function(creep) { // Does NOT move to healTarget TODO;
